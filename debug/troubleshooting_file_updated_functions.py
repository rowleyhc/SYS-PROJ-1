#Calling the functions from imports rather than copy pasting definitions(exception true_Constants)
#Henry Rowley
#9/17/2026
...
delta_v_total=mission_delV_ms*1000
g0=9.8
dv_step=1
delta_v1_min=100
print(min_mass_finder(LOX_LH2, LOX_LH2, delta_v_total,delta_v1_min,pyld_mass_kg, g0, dv_step))
print(min_cost_finder(LOX_LH2, LOX_LH2, delta_v_total, delta_v1_min, pyld_mass_kg, g0, dv_step))